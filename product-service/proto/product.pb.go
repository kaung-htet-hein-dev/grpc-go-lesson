...
const file_product_service_proto_product_proto_rawDesc = "" +
	"\n" +
	"#product-service/proto/product.proto\x12\aproduct\"{\n" +
	"\aProduct\x12\x0e\n" +
	...
	"\n" +
	"GetProduct\x12\x1a.product.GetProductRequest\x1a\x1b.product.GetProductResponseB!Z\x1fproduct-service/proto;productpbb\x06proto3"

var (
	file_product_service_proto_product_proto_rawDescOnce sync.Once
	file_product_service_proto_product_proto_rawDescData []byte
)
...
func file_product_service_proto_product_proto_rawDescGZIP() []byte {
	file_product_service_proto_product_proto_rawDescOnce.Do(func() {
		file_product_service_proto_product_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_product_service_proto_product_proto_rawDesc), len(file_product_service_proto_product_proto_rawDesc)))
	})
	return file_product_service_proto_product_proto_rawDescData
}

var file_product_service_proto_product_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
func file_product_service_proto_product_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_product_service_proto_product_proto_rawDesc), len(file_product_service_proto_product_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
